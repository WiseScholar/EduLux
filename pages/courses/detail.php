      ...
      <div class="col-lg-4">
        <div class="card shadow-lg p-4 sticky-top purchase-card">
          ...
          <hr class="my-3">
            ...
            <li><i class="fas fa-clock me-2 text-dark"></i> <strong>Total Lessons:</strong> <?= $total_lessons ?></li>
            <li><i class="fas fa-star me-2 text-warning"></i> <strong>Rating:</strong> 5.0 (Placeholder)</li>
            <li><i class="fas fa-users me-2 text-dark"></i> <strong>Students:</strong> 10,000+ (Placeholder)</li>
